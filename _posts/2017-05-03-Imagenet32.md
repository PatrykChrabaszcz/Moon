...
2. Use [image_resizer_imagenet.py](https://github.com/) script to resize images. See **--help** for more info 
```bash
...
3. Use [image2numpy_imagenet_train.py](https://github.com/) and [image2numpy_imagenet_val.py](https://github.com/) script to create files with training images and a files with validation images.
...
Script [test.py](https://github.com) will generate big 100x100 images containing all images from given file. Additionally it is possible to display histograms showing how many images are in this file for each of the classes.
