...
```
Note that first script requires lot of RAM, it should not be hard however to change the code to use less memory. Training images are randomly shuffled before they are divided into 10 parts and saved as 10 files. 
