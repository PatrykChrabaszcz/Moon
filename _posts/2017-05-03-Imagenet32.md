...
In a nutshell, this includes all images of ImageNet, resized to 32 x 32 pixels by the ‘box’ algorithm from the Pillow library. ImageNet64, Imagenet16 and Imagenet8 are very similar, just resized to 64x64, 16x16 and 8x8 pixels.

Like the original ImageNet, Imagenet32 and contain 1281167 training images from 1000 classes and 50000 validation images with 50 images per class.
...
The table below shows lowest validation error rates obtained on Downsampled ImageNet
